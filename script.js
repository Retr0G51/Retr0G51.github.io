...
function filterBySubcategory(subcategory) {
    ...
    const selectedOption = document.querySelector(`.filter-option[onclick*="${subcategory}"]`);
    if (selectedOption) {
    ...
    if (subcategory === 'todos') {
        // Mostrar todos los electrodomésticos
        showProducts('electrodomesticos');
    } else {
        // Filtrar por subcategoría
        const products = document.querySelectorAll('.product-card');
        products.forEach(product => {
            if (product.dataset.subcategory === subcategory) {
